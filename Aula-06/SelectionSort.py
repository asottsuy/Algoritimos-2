...
class SelectionSort():
    ...
    def selection_sort(self):
        ...
        for i in range(self.lista.tamanho): #vai iterar pelo tamanho da lista
            menor_n = no_atual  #!!! 1) define que o menor numero no momento e o elemento atual
            aux = no_atual.prox
            print(f"iterando pela {i}x")
            ...
            menor_n.dado, no_atual.dado = no_atual.dado, menor_n.dado
            self.lista.imprimir()
